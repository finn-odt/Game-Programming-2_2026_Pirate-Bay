...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class Rideable : Ability
    {
        ...
        [System.NonSerialized] protected Ride m_Ride;
        ...
        public override int AbilityIntData
        {
            get
            {
                ...
                return m_Ride != null ? m_Ride.AbilityIntData : int.MinValue;
            }
        }
        ...
        public override void Awake()
        {
            ...
            if (m_CharacterLocomotionHandler == null) {
                Debug.LogError("Error: The Rideable ability requires the UltimateCharacterLocomotionHandler.", m_GameObject);
            }
        ...
        /// <summary>
        /// Clears any input values forwarded from the riding character.
        /// </summary>
        private void ClearInputOverride()
        {
            if (m_CharacterLocomotionHandler == null) {
                return;
            }

            m_CharacterLocomotionHandler.OverriddenHorizontalMovement = 0;
            m_CharacterLocomotionHandler.OverriddenForwardMovement = 0;
            m_CharacterLocomotionHandler.OverriddenLookVector = Vector2.zero;
        }
        ...
        protected override void AbilityStarted()
        {
            ...
            if (m_NetworkInfo == null || m_NetworkInfo.HasAuthority() || m_NetworkInfo.IsLocalPlayer()) {
                ...
                SimulationManager.SetUpdateOrder(m_CharacterLocomotion, m_Ride.CharacterLocomotion);
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
            }
#endif
