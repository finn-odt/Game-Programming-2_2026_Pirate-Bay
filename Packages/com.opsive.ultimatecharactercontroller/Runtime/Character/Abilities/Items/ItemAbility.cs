...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public abstract class ItemAbility : Ability
    {
        ...
        {
            get { return -1; }
            set { Debug.LogWarning($"SlotID cannot be set to {value}."); }
        }
        ...
        protected void UpdateItemAbilityAnimatorParameters(bool forceChange = false)
        {
            EventHandler.ExecuteEvent(m_GameObject, "OnCharacterUpdateItemAbilityParameters", forceChange);
        }
    }
}