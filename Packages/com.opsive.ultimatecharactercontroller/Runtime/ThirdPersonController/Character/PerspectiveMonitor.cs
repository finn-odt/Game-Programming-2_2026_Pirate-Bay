...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Character
{
    ...
    public class PerspectiveMonitor : StateBehavior
    {
        ...
        private void StartInternal()
        {
            ...
            if (networkInfo != null && !networkInfo.HasAuthority() && !networkInfo.IsLocalPlayer() && !networkInfo.IsSpectator()) {
...
#endif
                UpdateThirdPersonMaterials(!firstPersonPerspective);
#if FIRST_PERSON_CONTROLLER
            }
#endif
        ...
        public void UpdateThirdPersonMaterials(bool forceThirdPerson)
        {
            ...
            for (int i = 0; i < m_ThirdPersonRenderers.Count; ++i) {
                ...
                m_Renderers[thirdPersonIndex].materials = ((firstPersonPerspective && !m_RendererThirdPersonObjects[thirdPersonIndex].ForceVisible && !forceThirdPerson) ?
